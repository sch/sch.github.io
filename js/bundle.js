...
var infernoCreateElement = infernoCreateElement$1;
...
function Checkbox (checked) {
  return infernoCreateElement("input", { type: "checkbox", checked })
}

function CheckboxCanvas (canvas) {
  const checkboxCanvas = canvas.map((row) => infernoCreateElement("div", null, row.map(Checkbox)));

  return infernoCreateElement("div", {
